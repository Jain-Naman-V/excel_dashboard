...
# Flask setup
# ---------------------------------------------------------------------------
# Ensure Flask knows where to find templates and static assets
# The templates live under `api/templates` and static under `static` at the project root
app = Flask(
    __name__,
    template_folder=os.path.join(os.path.dirname(__file__), "api", "templates"),
